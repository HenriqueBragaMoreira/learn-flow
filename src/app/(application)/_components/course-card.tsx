...
export function CourseCard({ course }: CourseCardProps) {
  return (
    <div className="bg-background rounded-xl shadow-sm overflow-hidden border border-accent hover:shadow-md transition-shadow">
      <div className="relative">
        <img
          src={"/placeholder.svg?height=400&width=800&text=Node.js"}
          alt={course.title}
